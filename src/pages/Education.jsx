    ...
    >
      ...
      <div className="grid grid-cols-1 gap-5">
        {items.map((item, index) => (
          ...
          >
            <div className="overflow-hidden rounded-[20px] border-4 border-white/[0.08]">
              <img
                src={item.image}
                alt=""
                loading="lazy"
            ...
            <div
              className="
              flex min-w-[175px] items-center justify-center
              justify-self-center rounded-full
              bg-gradient-to-r from-[var(--gold)] to-[#fde68a]
              px-5 py-2.5 text-center text-sm font-extrabold
              leading-tight text-[#07111d]
              shadow-[0_8px_24px_rgba(250,204,21,0.12)]
